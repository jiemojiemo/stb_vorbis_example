...
public:
    ...
    bool encode(std::vector<uint8_t> &inoutData, AudioFileFormat format = AudioFileFormat::Wave);
    ...
    const T* getReadPointer(int channelNumber) const;

    T* getWritePointer(int channelNumber);
...
private:
    ...
    //=============================================================
    bool encodeToWaveFile (std::vector<uint8_t> &inoutData);
    bool encodeToAiffFile (std::vector<uint8_t> &inoutData);
